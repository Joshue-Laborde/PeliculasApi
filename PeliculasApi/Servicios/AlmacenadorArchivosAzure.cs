...
namespace PeliculasApi.Servicios
{
    ...
    {
        private readonly string connectionStrring;

        public AlmacenadorArchivosAzure(IConfiguration configuration)
        {
            connectionStrring = configuration.GetConnectionString("AzureStorage");
        }
        public async Task BorrarArchivo(string ruta, string contenedor)
        {
            ...
            var cliente = new BlobContainerClient(connectionStrring, contenedor);
