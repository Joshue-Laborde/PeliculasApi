    ...
    public class ApplicationDbContext: IdentityDbContext
    {
      public ApplicationDbContext(DbContextOptions options): base(options)
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var username = "joshue@hotmail.com";
            ...
            var romance = new Genero() { Id = 4, Nombre = "Romance" };
            ...
            var jimCarrey = new Actor() { Id = 1, Nombre = "Jim Carrey", FechaNacimiento = new DateTime(1962, 01, 17) };
            var robertDowney = new Actor() { Id = 2, Nombre = "Robert Downey Jr.", FechaNacimiento = new DateTime(1965, 4, 4) };
            var chrisEvans = new Actor() { Id = 3, Nombre = "Chris Evans", FechaNacimiento = new DateTime(1981, 06, 13) };
