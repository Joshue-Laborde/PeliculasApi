...
namespace PeliculasApi.Controllers
{
    ...
    public class CuentasController : CustomBaseController
    {
        ...
        public CuentasController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration, ApplicationDbContext context, IMapper mapper) : base(context, mapper)
        {
